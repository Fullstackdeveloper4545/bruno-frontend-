...
function ProductsPage() {
  ...
  const paginationStart = filteredProducts.length === 0 ? 0 : (currentPage - 1) * PRODUCTS_PER_PAGE + 1
  const paginationEnd = filteredProducts.length === 0 ? 0 : Math.min(currentPage * PRODUCTS_PER_PAGE, filteredProducts.length)
  ...
  }, [categories, paginatedProducts, resolvedCategoryName, selectedCategoryId])
        ...
        >
          ...
          <div data-theme-layout-section='content'>
                ...
                <div className='mt-3 flex flex-col gap-3 md:flex-row md:items-end md:justify-between'>
                  ...
                  <div className='space-y-2 text-left md:text-right'>
                    ...
                    <p className='text-[12px] text-black/45'>
                      Showing {paginationStart}-{paginationEnd} of {visibleCount}
                    </p>
                  </div>
                </div>
            ...
            {filteredProducts.length > PRODUCTS_PER_PAGE ? (
              <div className='mt-8 flex flex-col gap-3 rounded-[24px] bg-white px-6 py-5 shadow-[0_16px_48px_rgba(0,0,0,0.05)] sm:flex-row sm:items-center sm:justify-between md:px-8'>
                ...
                <div className='flex flex-wrap items-center gap-2'>
                  <button
                    ...
                    className='rounded-full border border-black/10 px-4 py-2 text-[12px] font-medium text-black transition hover:bg-black hover:text-white disabled:cursor-not-allowed disabled:opacity-35'
                  >
                    Previous
                  </button>
