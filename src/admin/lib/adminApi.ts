...
export const adminApi = {
  ...
  addProductImage: (productId: string, payload: unknown) => postJson(`/api/products/${productId}/images`, payload),
  deleteProductImage: (productId: string, imageId: string | number) =>
    deleteJson(`/api/products/${productId}/images/${imageId}`),
