...
const AdminLayout = () => {
  ...
  return <SidebarProvider open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
    <div className="flex min-h-svh w-full items-stretch bg-[#f2f5f5]">
      ...
      <Sidebar className="z-50 hidden self-stretch border-r border-border/60 bg-sidebar text-sidebar-foreground md:flex" collapsible="icon" variant="inset">
        <SidebarHeader>
      ...
      <SidebarInset className="min-h-svh min-w-0 bg-[#f2f5f5]">
